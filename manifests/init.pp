# @summary Creates a NFS file system.
#
# @api public
#
...
#   Boolean. If set to <tt>true</tt>, this module will configure the node #   to act as a client server, you can use the exported mount resources #   from configured servers.
#
...
class nfs (
  ...
  String $client_services                                                                    = $nfs::params::client_services,
  String $client_nfsv4_services                                                              = $nfs::params::client_nfsv4_services,
  ...
  String $client_gssd_service_name                                                           = $nfs::params::client_gssd_service_name,
